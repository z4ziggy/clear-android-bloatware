#!/bin/bash
#
# to list installed samsung packages, use the following command:
# "adb shell pm list packages | grep samsung"
#
# avoid removing all packages since some of them are actually essential.
#
...
adb shell pm uninstall -k --user 0 com.samsung.oh
